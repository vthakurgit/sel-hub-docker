package com.vthakur.pages.vendorportal;
...
public class DashboardPage extends AbstractPage {
    ...
    @FindBy(css = "#userDropdown img") // #userDropdown img OR img.img-profile
    private WebElement userProfilePictureElement;

    //Order to find element > prefer id / name / css /last item: linkText
